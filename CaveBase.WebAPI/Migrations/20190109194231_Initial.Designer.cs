...
namespace CaveBase.WebAPI.Migrations
{
    ...
    [Migration("20190109194231_Initial")]
            ...
            modelBuilder.Entity("CaveBase.Library.Models.Caver", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Created = new DateTime(2019, 1, 9, 20, 42, 31, 212, DateTimeKind.Local), FirstName = "Maxim", LastName = "Lesy" },
                        new { Id = 2, Created = new DateTime(2019, 1, 9, 20, 42, 31, 212, DateTimeKind.Local), FirstName = "Evi", LastName = "De Baets" },
                        new { Id = 3, Created = new DateTime(2019, 1, 9, 20, 42, 31, 212, DateTimeKind.Local), FirstName = "Charlotte", LastName = "Janssens" }
                    );
                });
            ...
            modelBuilder.Entity("CaveBase.Library.Models.DifficultyRating", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CaveId = 1, CaverId = 1, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 5 },
                        new { Id = 2, CaveId = 1, CaverId = 2, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 2 },
                        new { Id = 3, CaveId = 1, CaverId = 3, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 1 },
                        new { Id = 4, CaveId = 2, CaverId = 1, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 4 },
                        new { Id = 5, CaveId = 2, CaverId = 3, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 1 },
                        new { Id = 6, CaveId = 2, CaverId = 3, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 2 },
                        new { Id = 7, CaveId = 3, CaverId = 1, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 1 },
                        new { Id = 8, CaveId = 3, CaverId = 2, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 5 },
                        new { Id = 9, CaveId = 3, CaverId = 1, Created = new DateTime(2019, 1, 9, 20, 42, 31, 213, DateTimeKind.Local), Difficulty = 1 }
                    );
                });
